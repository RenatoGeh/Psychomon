...
O jeito que os ataques foram implementados foi uma tarefa bem simples, pois como os
ataques só dão dano direto e não causam efeitos secundários. Além disso, como não é
possível mudar de pokemon durante a batalha, não existe necessidade de \emph{economizar}
PPs para usar em batalhas futuras, basta apenas escolher o ataque disponível que tem maior
"dano médio".
